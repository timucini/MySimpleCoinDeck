...
object FakeResponseDataAndroid {

    val singleCoin = Coin("", AllTimeHigh("",0), "", "", "",
        "", "", "", listOf(), false, "", "", 0,
        0, "", 0, listOf(), Supply("",false,""), "",
        0, "uuid", "")

    val coinRankingEntity = com.example.mysimplecoindeck.models.Coin("100","1","1","google.de","red",
    ...
    val singleCoinsResponse = CoinResponse(com.example.mysimplecoindeck.models.singleCoin.Data(singleCoin),"success")
